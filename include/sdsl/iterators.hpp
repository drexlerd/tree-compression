...
public:
    ...
    using size_type = typename t_rac::size_type;

    using iterator = random_access_const_iterator<t_rac>;
...
public:
    ...
    const reference operator*() const { return (*m_rac)[m_idx]; }
...
template<class t_rac>
inline typename random_access_const_iterator<t_rac>::difference_type operator-(const random_access_const_iterator<t_rac>& x,
                                                                               const random_access_const_iterator<t_rac>& y)
{
    return (typename random_access_const_iterator<t_rac>::difference_type) x.m_idx - (typename random_access_const_iterator<t_rac>::difference_type) y.m_idx;
}
