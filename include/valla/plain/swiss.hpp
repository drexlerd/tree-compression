...
/// @return the slot representing the subsequence it to end.
...
inline const_iterator begin(Slot root, const IndexedHashSet<Slot>& table) { return const_iterator(table, root, true); }
